...
$result1 = $db->query("select * from images where `session_name`='$username'");

echo "<table><tr><th>cars</th><th>model</th><th>mileage</th><th>year</th><th>price</th></tr>";

if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        echo "<tr><th> ".$row["cars"]. "</th><th>" . $row["model"]. "</th><th>" . $row["mileage"]."</th><th>".$row["year"]."</th><th>".$row["price"]."  </th></tr><br>";
    }
    echo "</table>";
} else {
    echo "0 results";
...
<body>
    ...
    <div id="login_message">Please login or signup first!<br> Thank you for your corporation!</div>
