...
$result = $db->query("SELECT * FROM images WHERE `session_name`='$username' "); 
...
<div id="main">
    ...
    <header>
        ...
        <nav>
            <ul class="nav_bars">
                <li><a id="nav_bar1" href="sell.php">Add a new record</a></li>
...
<table>
    ...
    <div class="gallery">
        ...
        <tr>
            <th><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" /> </th>
            <th>Car type: <?php echo $row["cars"]?><br> Year: <?php echo $row["year"]?><br>Model:
                <?php echo $row["model"]?><br>Mileage less than <?php echo $row["mileage"]?> miles<br>Price:
                $<?php echo $row["price"]?><br><br>

                <?php echo "<a href='delete.php?did=".$row['id']."'>Delete</a >";?></th>
            <?php 
...
<div id="Social_Media">
    <div class="center">
        ...
        <a id="sm5" href="https://www.youtube.com/watch?v=3HfVNXfMh0E&feature=youtu.be" class="fa fa-youtube"></a>
    </div>
    </body>
