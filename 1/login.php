...
<li>
    ...
    <input type="checkbox" id="checkid"  name="rememberMe" title="rememberMe" value="1" />Remember Username</label>
 </li>     
      <input type="submit" id="button" value="Login" name="login">
       <button type="submit" id="button" value="admin_login" name="admin_login" formnovalidate>Admin Pass Button</button>
      <p class="message"></p>
    </form>
